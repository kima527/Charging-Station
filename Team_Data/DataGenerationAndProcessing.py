...
def get_routes(): # Loads locations of denseley populated areas and connects them via shortest path (OD-pair creation)
    ...
    routes_nodes = {
        "Perlach to Neuhausen": nx.shortest_path(G, nearest_nodes["Perlach"], nearest_nodes["Neuhausen"],
                                                 weight='length'),
        "Thalkirchen to Freimann": nx.shortest_path(G, nearest_nodes["Thalkirchen"], nearest_nodes["Freimann"],
                                                    weight='length'),
        "Bogenhausen to Thalkirchen": nx.shortest_path(G, nearest_nodes["Bogenhausen"], nearest_nodes["Thalkirchen"],
                                                       weight='length'),
        "Bogenhausen to Neuhausen": nx.shortest_path(G, nearest_nodes["Bogenhausen"], nearest_nodes["Neuhausen"],
                                                     weight='length'),
        "Perlach to Freimann": nx.shortest_path(G, nearest_nodes["Perlach"], nearest_nodes["Freimann"],
                                                weight='length'),
        "Hadern to Neuhausen": nx.shortest_path(G, nearest_nodes["Hadern"], nearest_nodes["Neuhausen"],
                                                weight='length'),
        "Moosach to Neuhausen": nx.shortest_path(G, nearest_nodes["Moosach"], nearest_nodes["Neuhausen"],
                                                 weight='length'),
        "Moosach to Feldmoching": nx.shortest_path(G, nearest_nodes["Moosach"], nearest_nodes["Feldmoching"],
                                                   weight='length'),
        "Feldmoching to Freimann": nx.shortest_path(G, nearest_nodes["Feldmoching"], nearest_nodes["Freimann"],
                                                    weight='length'),
        "Freimann to Oberfoehring": nx.shortest_path(G, nearest_nodes["Freimann"], nearest_nodes["Oberfoehring"],
                                                     weight='length'),
        "Oberfoehring to Bogenhausen": nx.shortest_path(G, nearest_nodes["Oberfoehring"], nearest_nodes["Bogenhausen"],
                                                        weight='length'),
        "Bogenhausen to Berg-am-Laim": nx.shortest_path(G, nearest_nodes["Bogenhausen"], nearest_nodes["Berg-am-Laim"],
                                                        weight='length'),
        "Berg-am-Laim to Perlach": nx.shortest_path(G, nearest_nodes["Berg-am-Laim"], nearest_nodes["Perlach"],
                                                    weight='length'),
        "Perlach to Giesing": nx.shortest_path(G, nearest_nodes["Perlach"], nearest_nodes["Giesing"], weight='length'),
        "Giesing to Thalkirchen": nx.shortest_path(G, nearest_nodes["Giesing"], nearest_nodes["Thalkirchen"],
                                                   weight='length'),
        "Thalkirchen to Sendling": nx.shortest_path(G, nearest_nodes["Thalkirchen"], nearest_nodes["Sendling"],
                                                    weight='length'),
        "Sendling to Hadern": nx.shortest_path(G, nearest_nodes["Sendling"], nearest_nodes["Hadern"], weight='length'),
    }

    # Stores the distance between OD-pairs
    routes_length = {
        "Perlach to Neuhausen": nx.shortest_path_length(G, nearest_nodes["Perlach"], nearest_nodes["Neuhausen"],
                                                        weight='length'),
        "Thalkirchen to Freimann": nx.shortest_path_length(G, nearest_nodes["Thalkirchen"], nearest_nodes["Freimann"],
                                                           weight='length'),
        "Bogenhausen to Thalkirchen": nx.shortest_path_length(G, nearest_nodes["Bogenhausen"],
                                                              nearest_nodes["Thalkirchen"], weight='length'),
        "Bogenhausen to Neuhausen": nx.shortest_path_length(G, nearest_nodes["Bogenhausen"], nearest_nodes["Neuhausen"],
                                                            weight='length'),
        "Perlach to Freimann": nx.shortest_path_length(G, nearest_nodes["Perlach"], nearest_nodes["Freimann"],
                                                       weight='length'),
        "Hadern to Neuhausen": nx.shortest_path_length(G, nearest_nodes["Hadern"], nearest_nodes["Neuhausen"],
                                                       weight='length'),
        "Moosach to Neuhausen": nx.shortest_path_length(G, nearest_nodes["Moosach"], nearest_nodes["Neuhausen"],
                                                        weight='length'),
        "Moosach to Feldmoching": nx.shortest_path_length(G, nearest_nodes["Moosach"], nearest_nodes["Feldmoching"],
                                                          weight='length'),
        "Feldmoching to Freimann": nx.shortest_path_length(G, nearest_nodes["Feldmoching"], nearest_nodes["Freimann"],
                                                           weight='length'),
        "Freimann to Oberfoehring": nx.shortest_path_length(G, nearest_nodes["Freimann"], nearest_nodes["Oberfoehring"],
                                                            weight='length'),
        "Oberfoehring to Bogenhausen": nx.shortest_path_length(G, nearest_nodes["Oberfoehring"],
                                                               nearest_nodes["Bogenhausen"], weight='length'),
        "Bogenhausen to Berg-am-Laim": nx.shortest_path_length(G, nearest_nodes["Bogenhausen"],
                                                               nearest_nodes["Berg-am-Laim"], weight='length'),
        "Berg-am-Laim to Perlach": nx.shortest_path_length(G, nearest_nodes["Berg-am-Laim"], nearest_nodes["Perlach"],
                                                           weight='length'),
        "Perlach to Giesing": nx.shortest_path_length(G, nearest_nodes["Perlach"], nearest_nodes["Giesing"],
                                                      weight='length'),
        "Giesing to Thalkirchen": nx.shortest_path_length(G, nearest_nodes["Giesing"], nearest_nodes["Thalkirchen"],
                                                          weight='length'),
        "Thalkirchen to Sendling": nx.shortest_path_length(G, nearest_nodes["Thalkirchen"], nearest_nodes["Sendling"],
                                                           weight='length'),
        "Sendling to Hadern": nx.shortest_path_length(G, nearest_nodes["Sendling"], nearest_nodes["Hadern"],
                                                      weight='length'),
    }
